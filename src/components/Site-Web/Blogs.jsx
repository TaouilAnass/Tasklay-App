...
export default function Blogs() {
  return (
    <div className='w-full h-auto p-5 mt-5  shadow-[rgba(17,_17,_26,_0.1)_0px_0px_30px]' id='Blogs'>
      <div className='text-center flex justify-center items-center mt-5'>
        <h1 class="text-4xl font-extrabold text-gray-900 sm:text-4xl dark:text-white" style={{ fontFamily: 'baloo' }}><span className='rounded-lg border-2 border-purple-600 p-0.5 bg-purple-600 font-semibold text-white text-4xl'>B</span>logs</h1>
      </div>
