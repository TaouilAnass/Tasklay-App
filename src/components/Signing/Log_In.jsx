...
import Login_img from "../Img/login-img1.png"
        ...
        <div class="min-h-screen bg-gray-50 text-gray-900 flex justify-center dark:bg-gray-900 ">
            <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow-xl sm:rounded-lg flex justify-center flex-1 dark:bg-gray-900 dark:border-2 dark:border-white">
                        ...
                        <div class="w-full flex-1 mt-8">
                            ...
                            <div class="mx-auto max-w-xs">
                                ...
                                {show ?
                                    ...
                                    : ''}
                                <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" type="email" placeholder="Email" required onChange={(e) => setUsername(e.target.value)} />
                                ...
                                <button class="group outline-none text-blue-400 transition-all duration-100 ease-in-out"  onClick={() => document.getElementById('Forget_Pass').showModal()}>
                                ...
                                <button
                                    ...
                                    <IoEnter class="w-6 h-6 -ml-2" />
                                    <span class="ml-3">
                                        Login
                                    </span>
                                </button>
                                <h3 class="mt-6 text-sm text-gray-600 text-center dark:text-gray-300 ">
                                    Don't have an account?
                                    <button class="ml-2 group text-blue-400 transition-all duration-100 ease-in-out text-sm" >
                                        <span class="bg-left-bottom bg-gradient-to-r from-blue-400 to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out" onClick={() => nav('/Signing')}>
                                            Sign Up
                                        </span>
                                    </button>
                                </h3>
                ...
                <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
                    <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style={{ backgroundImage: `url(${Login_img})` }}>
